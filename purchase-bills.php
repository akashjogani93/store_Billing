...
<div class="col-md-12 bg-success">
  <h3 class="text-center" style="color:black; margin-top:3px; margin-bottom:10px;">Purchase Entry</h3>
</div>
...
<div class="col-md-12 theam" id="fetch_table" style="margin-top: -10px;">
    <table class="fixed_header1 table table-bordered" id="table">
        ...
        <?php 
            include("connect.php");
            $q='SELECT * FROM `purchase_tot` ORDER BY `bill_no` ASC';
...
<script>
    $(document).ready(function()
    {
        ...
        var bill_no = currow.find('td:eq(0)').html();
            // alert(item_id)
        window.location="purchase_single_bill.php?bill="+bill_no;
        });
    });
